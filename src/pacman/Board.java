...
public class Board extends JPanel implements ActionListener {
    ...
    private final int BLOCK_SIZE = 24; //kich thuoc 1 khoi
    private final int N_BLOCKS = 15; // Số khối
 ...
 // hai bien dau la toa do, hai bien sau la thay doi delta theo huong ngang va doc
    private int pacman_x, pacman_y, pacmand_x, pacmand_y;
    private int req_dx, req_dy, view_dx, view_dy;
    
// Ve ban do va cac cham diem
...
//  Xác định hình ảnh pacman được vẽ. Ngoài ra còn có hằng số PAC_ANIM_DELAY làm cho hình ảnh động chậm hơn một chút.
    private void doAnim() {
...
// Ghi điểm ra màn hình    
    private void drawScore(Graphics2D g) {
        ...
        for (i = 0; i < pacsLeft; i++) {
            g.drawImage(pacman3right, i * 28 + 8, SCREEN_SIZE + 1, this);
        }
    }
// kiểm tra xem còn chấm điểm nào ko . nếu hết thì trò chơi kết thúc và bắt đầu lại.
...
// di chuyển ngẫu nhiên và tốc độ của ghost
